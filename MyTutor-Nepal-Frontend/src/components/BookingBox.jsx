import { Box, Button, Flex, FormControl, FormErrorMessage, Select, Text, Textarea, VStack } from "@chakra-ui/react";
import TextField from "./common/TextField";

const BookingBox = ({setPrice,setSubject,errors,handleBooking,handleSubmit,register, tutor}) => {
  return (
    <Box
    p={"30px"}
    boxShadow={"lg"}
